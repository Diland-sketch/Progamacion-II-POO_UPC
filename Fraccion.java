...
public class Fraccion {
    ...
    public Fraccion multiplicar(Fraccion f){
        int numerador = (this.getNumerador() * f.getNumerador());
        int denominador = (this.getDenominador() * f.getDenominador());
        Fraccion res = new Fraccion(numerador, denominador);
        return res;
    }
    ...
    public Fraccion restar(Fraccion f){
        int numerador = (this.getNumerador()*f.getDenominador()) - (this.getDenominador()*f.getNumerador());
        int denominador = this.getDenominador() * f.getDenominador();
        Fraccion res = new Fraccion(numerador, denominador);
        return res;
    }
    ...
    public Fraccion dividir(Fraccion f){
        int numerador = this.getNumerador() * f.getDenominador();
        int denominador = this.getDenominador() * f.getNumerador();
        Fraccion res = new Fraccion(numerador, denominador);
        return res;
    }
